        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center justify-center">
          ...
          <div className="flex-1 lg:flex-none lg:w-1/2 text-center lg:text-left space-y-6 lg:space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-white/80 text-balance leading-relaxed">
                {t.hero.subtitle}
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 lg:gap-6 pt-6 lg:pt-8">
              <div className="text-center">
                ...
                <p className="text-xs lg:text-sm text-white/80">Installations</p>
              </div>
              <div className="text-center">
                <div className="text-xl lg:text-2xl font-bold mb-1">50MW</div>
                <p className="text-xs lg:text-sm text-white/80">Capacity</p>
              </div>
              <div className="text-center">
                <div className="text-xl lg:text-2xl font-bold mb-1">10k+</div>
                <p className="text-xs lg:text-sm text-white/80">Happy Customers</p>
              </div>
            </div>
          </div>
